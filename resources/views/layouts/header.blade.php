        ...
        <div class="flex items-center gap-3 2xsm:gap-7">
            <ul class="flex items-center gap-2 2xsm:gap-4">
                ...
                {{-- <li class="relative" x-data="{ dropdownOpen: false, notifying: true }" @click.outside="dropdownOpen = false">
                    <a class="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white"
                        href="javascript:void(0)" @click.prevent="dropdownOpen = ! dropdownOpen; notifying = false">
                        ...
                        <ul class="flex h-auto flex-col overflow-y-auto">
                            <li>
                                <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                                    href="javascript:void(0)">
                                    <span
                                        class="h-12 w-12 rounded-full overflow-hidden flex items-center justify-center">
                                        <x-user-svg />
                                    </span>
            ...
            @auth
                <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                    <a class="flex items-center gap-4" href="javascript:void(0)"
                    ...
                    <div x-show="dropdownOpen"
                        ...
                        <x-dropdown-link :href="route('dashboard')"
                            class="flex items-center gap-3.5 py-4 px-6 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base hover:dark:text-primary">
                            <x-user-svg />
                            {{ __('My Profile') }}
                        </x-dropdown-link>
