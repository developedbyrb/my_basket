                        ...
                        @forelse ($productDetails->skus as $sku)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                <td class="custom-table-row pl-9">
                                    @if ($sku->image)
                                        <img class="w-12 h-12 p-1 max-w-max rounded-full ring-2 ring-gray-300 dark:ring-gray-500"
                                ...
                                @if (\Helper::hasPermissionToView('buy-bulk-products'))
                                    <td colspan="5" class="px-6 py-4">
                                        <form action="{{ route('products.addToCart', $sku->id) }}" method="post">
                                            @csrf
                                            <button type="submit"
                                                class="inline-flex w-max items-center text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-blue-900">
